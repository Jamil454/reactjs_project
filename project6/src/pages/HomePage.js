    ...
    <>
      ...
      <div id="content" className="no-bottom no-top">
        ...
        <section
          ...
          data-video-src="mp4:video/local-video-1.mp4"
        >
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-6">
                  ...
                  <p className="lead">
                    Lorem ipsum enim dolor ea anim reprehenderit laboris aliquip
                    sed dolore.
                  </p>
              ...
              <div className="col-lg-4">
                <div className="de-room">
                  ...
                  <div className="d-text">
                    <h3>Standard Room</h3>
                    <p>
                      Most hotels and major hospitality companies have set
                      industry standards to classNameify hotel types. An upscale
                      full-service hotel facility offers luxury...
                    </p>
                    <Link to={"02-room-single.html"} className="btn-line">
                      <span>Book Now For $29</span>
                    </Link>
                  </div>
                </div>
              </div>
                ...
                >
                  <blockquote className="testimonial-big">
                    <span className="d-testi">
                      ...
                      enjoyable. I highly recommend this hotel for anyone
                      visiting downtown
                    </span>
                  ...
                  <blockquote className="testimonial-big">
                    <span className="d-testi">
                      They were extremely accommodating and allowed us to check
                      in early at like 10am. We got to hotel super early and I
                  ...
                  <blockquote className="testimonial-big">
                    <span className="d-testi">
                      I had a wonderful experience at the hotel. Every staff
                      member I encountered, from the valet to the check- in to
                      the cleaning staff were delightful and eager to help!
                      Thank you! Will recommend to my colleagues!
                    </span>
